...
interface ApiKeyModalProps {
  ...
  onProxyConfigChange?: (key: string, isp: string, location: string) => void;
}
...
export const ApiKeyModal: React.FC<ApiKeyModalProps> = ({
  ...
  }, [elevenLabsApiKey, geminiApiKey, proxyKey, proxyISP, proxyLocation, isOpen]);
  ...
  const handleSaveProxy = () => {
      if (onProxyConfigChange) {
          onProxyConfigChange(proxyKeyInput.trim(), proxyISPInput, proxyLocationInput);
        ...
        <div className="p-2 overflow-y-auto custom-scrollbar">
            ...
            <div className="mb-4 pt-6 border-t border-slate-600">
             ...
             <div className="mb-4 pt-6 border-t border-slate-600">
              ...
              <p className="text-slate-400 text-xs mb-4">
                Sử dụng Key từ <a href="https://proxy.vn/?home=proxyxoay" target="_blank" rel="noreferrer" className="text-[--color-primary-400] hover:underline">proxyxoay.shop</a>. Khi kích hoạt, tool sẽ tự động kết nối qua server trung gian.
              </p>
